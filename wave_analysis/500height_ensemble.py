...
#SBATCH -J 500height_ensemble.py
#SBATCH -o 500height_ens_out
#SBATCH -e 500height_ens_error
#SBATCH -A marine-cpu
#SBATCH --ntasks=1
...
def main():
    ...
    YEAR = "2020"
    OUT_FILE = "500Height" + YEAR + "w_ensemble.nc"
    ...
    fe.files_to_ens("HGT_500mb", OUT_FILE, filelist)
