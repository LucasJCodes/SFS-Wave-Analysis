...
def main():
    ...
    cbar1 = plt.colorbar(im1, location = "bottom", label = "deg C")
    ...
    cbar2 = plt.colorbar(im2, location = "bottom", label = "deg C")
    ...
    cbar3 = plt.colorbar(im3, location = "bottom", extend = "both", label = "deg C")
    ...
    cbar4 = plt.colorbar(im4, location = "bottom", extend = "both", label = "%")
    cbar4.ax.tick_params(rotation = -60, labelsize = 6)
